                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h6 class="mb-0">Responsive Table</h6>
                                 <div class="d-flex justify-content-between align-items-center mb-3">
                                    <a href="hlc_users.php" class="btn btn-primary mx-1">List Page</a>
                                    <a href="update_details.php?pid=<?php echo $_GET['id']; ?>" class="btn btn-primary mx-1">Update Details</a>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $response = get_all_users($conn, $_GET['id']);
